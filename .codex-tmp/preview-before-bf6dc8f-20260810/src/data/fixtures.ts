    ...
    attention: [
      {
        ...
        title: "A message is ready to send",
        detail: "The partner follow-up is drafted and waiting for your approval.",
        severity: "warning",
        action: {
          id: "send-partner-follow-up",
          kind: "acknowledge_alert",
          label: "Review and send",
          description: "Send the prepared follow-up to the project partner.",
        },
      },
    ],
    sources: [
